...
def generate_plant_list():
    # Load environment variables
    load_dotenv()
    
    # File paths
    input_file = r'D:\WRMSWork\Network-Planner-Api\NetworkSupplier\uploads\dairy_customers.xlsx'
    output_file = r'D:\WRMSWork\Network-Planner-Api\NetworkSupplier\uploads\plant_list.xlsx'
    ...
    try:
        ...
        # Filter rows where TypeName is 'Plant'
        plant_df = df[df['TypeName'] == 'Plant']
        ...
        for index, row in plant_df.iterrows():
            ...
            record = {
                ...
                "Latitude": lat,
                "Longitude": lon,
                "Capacity": 1.0,  # Model requires Capacity > 0
                "IsActive": True,
                "CreatedBy": None,
                "CreatedDate": now,
                "UpdatedBy": None,
        ...
        if records:
            ...
            print(f"Successfully inserted {len(result.inserted_ids)} records into the PlantMaster collection.")
